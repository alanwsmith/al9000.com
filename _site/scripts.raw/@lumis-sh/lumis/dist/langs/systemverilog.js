...
("{" @open
  "}" @close)`,
  wasm: { packageName: "@lumis-sh/wasm-systemverilog", name: "tree-sitter-systemverilog", version: "0.26" }
};
var systemverilog_default = language;

export { systemverilog_default as default };
