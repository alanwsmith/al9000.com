import { getScopedThemeStyle } from './chunk-XN6RKY5Q.js';
...
var LANGUAGE_LOADERS = {
  "angular": () => import('./langs/angular.js'),
  "asm": () => import('./langs/asm.js'),
  "astro": () => import('./langs/astro.js'),
  "bash": () => import('./langs/bash.js'),
  "c": () => import('./langs/c.js'),
  "caddy": () => import('./langs/caddy.js'),
  "clojure": () => import('./langs/clojure.js'),
  "cmake": () => import('./langs/cmake.js'),
  "comment": () => import('./langs/comment.js'),
  "commonlisp": () => import('./langs/commonlisp.js'),
  "cpp": () => import('./langs/cpp.js'),
  "csharp": () => import('./langs/csharp.js'),
  "css": () => import('./langs/css.js'),
  "csv": () => import('./langs/csv.js'),
  "dart": () => import('./langs/dart.js'),
  "diff": () => import('./langs/diff.js'),
  "dockerfile": () => import('./langs/dockerfile.js'),
  "eex": () => import('./langs/eex.js'),
  "ejs": () => import('./langs/ejs.js'),
  "elixir": () => import('./langs/elixir.js'),
  "elm": () => import('./langs/elm.js'),
  "erb": () => import('./langs/erb.js'),
  "erlang": () => import('./langs/erlang.js'),
  "fish": () => import('./langs/fish.js'),
  "fsharp": () => import('./langs/fsharp.js'),
  "gleam": () => import('./langs/gleam.js'),
  "glimmer": () => import('./langs/glimmer.js'),
  "go": () => import('./langs/go.js'),
  "graphql": () => import('./langs/graphql.js'),
  "haskell": () => import('./langs/haskell.js'),
  "hcl": () => import('./langs/hcl.js'),
  "heex": () => import('./langs/heex.js'),
  "html": () => import('./langs/html.js'),
  "http": () => import('./langs/http.js'),
  "iex": () => import('./langs/iex.js'),
  "ini": () => import('./langs/ini.js'),
  "java": () => import('./langs/java.js'),
  "javascript": () => import('./langs/javascript.js'),
  "json": () => import('./langs/json.js'),
  "julia": () => import('./langs/julia.js'),
  "kotlin": () => import('./langs/kotlin.js'),
  "latex": () => import('./langs/latex.js'),
  "liquid": () => import('./langs/liquid.js'),
  "llvm": () => import('./langs/llvm.js'),
  "lua": () => import('./langs/lua.js'),
  "make": () => import('./langs/make.js'),
  "markdown": () => import('./langs/markdown.js'),
  "markdown_inline": () => import('./langs/markdown_inline.js'),
  "nix": () => import('./langs/nix.js'),
  "nushell": () => import('./langs/nushell.js'),
  "objc": () => import('./langs/objc.js'),
  "ocaml": () => import('./langs/ocaml.js'),
  "ocaml_interface": () => import('./langs/ocaml_interface.js'),
  "perl": () => import('./langs/perl.js'),
  "php": () => import('./langs/php.js'),
  "powershell": () => import('./langs/powershell.js'),
  "protobuf": () => import('./langs/protobuf.js'),
  "python": () => import('./langs/python.js'),
  "r": () => import('./langs/r.js'),
  "regex": () => import('./langs/regex.js'),
  "ruby": () => import('./langs/ruby.js'),
  "rust": () => import('./langs/rust.js'),
  "scala": () => import('./langs/scala.js'),
  "scss": () => import('./langs/scss.js'),
  "sql": () => import('./langs/sql.js'),
  "surface": () => import('./langs/surface.js'),
  "svelte": () => import('./langs/svelte.js'),
  "swift": () => import('./langs/swift.js'),
  "toml": () => import('./langs/toml.js'),
  "tsx": () => import('./langs/tsx.js'),
  "typescript": () => import('./langs/typescript.js'),
  "typst": () => import('./langs/typst.js'),
  "vim": () => import('./langs/vim.js'),
  "vue": () => import('./langs/vue.js'),
  "wat": () => import('./langs/wat.js'),
  "xml": () => import('./langs/xml.js'),
  "yaml": () => import('./langs/yaml.js'),
  "zig": () => import('./langs/zig.js'),
  "arduino": () => import('./langs/arduino.js'),
  "bicep": () => import('./langs/bicep.js'),
  "dot": () => import('./langs/dot.js'),
  "editorconfig": () => import('./langs/editorconfig.js'),
  "gitattributes": () => import('./langs/gitattributes.js'),
  "javadoc": () => import('./langs/javadoc.js'),
  "jq": () => import('./langs/jq.js'),
  "kdl": () => import('./langs/kdl.js'),
  "luadoc": () => import('./langs/luadoc.js'),
  "nim": () => import('./langs/nim.js'),
  "pascal": () => import('./langs/pascal.js'),
  "puppet": () => import('./langs/puppet.js'),
  "terraform": () => import('./langs/terraform.js'),
  "toon": () => import('./langs/toon.js'),
  "wgsl": () => import('./langs/wgsl.js'),
  "zsh": () => import('./langs/zsh.js'),
  "d": () => import('./langs/d.js'),
  "fortran": () => import('./langs/fortran.js'),
  "gitignore": () => import('./langs/gitignore.js'),
  "glsl": () => import('./langs/glsl.js'),
  "jinja": () => import('./langs/jinja.js'),
  "jinja_inline": () => import('./langs/jinja_inline.js'),
  "json5": () => import('./langs/json5.js'),
  "just": () => import('./langs/just.js'),
  "matlab": () => import('./langs/matlab.js'),
  "mermaid": () => import('./langs/mermaid.js'),
  "nginx": () => import('./langs/nginx.js'),
  "prisma": () => import('./langs/prisma.js'),
  "qmljs": () => import('./langs/qmljs.js'),
  "racket": () => import('./langs/racket.js'),
  "rst": () => import('./langs/rst.js'),
  "scheme": () => import('./langs/scheme.js'),
  "solidity": () => import('./langs/solidity.js'),
  "systemverilog": () => import('./langs/systemverilog.js'),
  "tcl": () => import('./langs/tcl.js'),
  "vhdl": () => import('./langs/vhdl.js'),
  "plaintext": () => import('./langs/plaintext.js')
};
...
function runHighlightIter(runtime, source, language, theme, onToken) {
  ...
  for (const event of events) {
    ...
    onToken(
      ...
      scope,
      scope.length > 0 ? getScopedThemeStyle(theme, scope, tokenLanguage) : void 0
    );
  }
}
...
export { PLAINTEXT_LANG_ID, createHighlighterModule, highlightEvents, highlightIter };
