...
("{" @open
  "}" @close)`,
  wasm: { packageName: "@lumis-sh/wasm-markdown_inline", name: "tree-sitter-markdown_inline", version: "0.26" }
};
var markdown_inline_default = language;

export { markdown_inline_default as default };
