...
export { HIGHLIGHT_NAMES, appendFragment, appendThemeCssVars, attrsToString, availableThemes, buildNormalThemeVars, buildPreThemeStyle, closeCodeTag, closePreTag, closeTag, closingTags, decodeSourceSlice, encodeSource, escape, escapeAttr, escapeBraces, escapeFragment, formatHighlightIterLines, getHighlightLineClass, getScopedThemeStyle, getThemeStyle, joinClasses, lineIsHighlighted, linesFromOffsets, openCodeTag, openPreTag, openSpanTag, openTag, renderEvents, renderHtmlBlock, renderLinesFromEvents, sanitizeThemeName, scopeToClass, spanInline, spanInlineAttrs, spanLinked, spanLinkedAttrs, spanMultiThemes, spanMultiThemesAttrs, styleToCss, textDecoration, wrapLine, wrapWithHeader };
