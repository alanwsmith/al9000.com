...
("{" @open
  "}" @close)`,
  wasm: { packageName: "@lumis-sh/wasm-jinja_inline", name: "tree-sitter-jinja_inline", version: "0.26" }
};
var jinja_inline_default = language;

export { jinja_inline_default as default };
