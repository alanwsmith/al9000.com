...
export function fixLink(_, __, el) {
  el.value = "";
  b.forwardSender(el, "updateAmazonLinkFixer");
}

export function copyAmazonLinkFixer(_, sender, el) {
  b.quickCopy(el, sender);
}

export function showAmazonLinkFixerExample(_, __, el) {
  b.info("asdf");
  el.value =
...
export function updateAmazonLinkFixer(_, sender, el) {
