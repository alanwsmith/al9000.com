...
("{" @open
  "}" @close)`,
  wasm: { packageName: "@lumis-sh/wasm-ocaml_interface", name: "tree-sitter-ocaml_interface", version: "0.26" }
};
var ocaml_interface_default = language;

export { ocaml_interface_default as default };
